...
{
    [Fact]
    public void FilterBy_ValidExpression_ReturnsMatchingCategories()
    {
    ...
    [Fact]
    public void FilterBy_ImplicitAnyCriteria_ReturnsMatchingCategories()
    {
    ...
    [Fact]
    public void FilterBy_ExplicitAnyCriteria_ReturnsMatchingCategories()
    {
    ...
    [Fact]
    public void FilterBy_ExplicitAllCriteria_ReturnsMatchingCategory()
    {
    ...
    [Fact]
    public void FilterBy_NestedPropertyImplicitAny_ReturnsMatchingCategories()
    {
    ...
    [Fact]
    public void FilterBy_NestedPropertyExplicitAll_ReturnsMatchingCategory()
    {
    ...
    [Fact]
    public void FilterBy_AllCriteriaNoMatches_ReturnsEmpty()
    {
    ...
    public void FilterBy_UsingCountProjection_ReturnsMatchingCategories(string expression, IEnumerable<string> expectedCategories)
    {
